...
* The original package name 'com.example.spring-boot3-webclient-sync-example' is invalid and this project uses 'com.example.springboot3webclientsyncexample' instead.
